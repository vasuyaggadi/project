...
--
-- Host: localhost
-- Generation Time: Oct 05, 2023 at 11:47 AM
...
--
-- Database: `a_machine_learning_approach_using_statistical_models`
--
CREATE DATABASE IF NOT EXISTS `a_machine_learning_approach_using_statistical_models` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `a_machine_learning_approach_using_statistical_models`;
...
('99g66axzx7jy62ffad0kg2k9939xwn1s', 'eyJ1c2VyaWQiOjF9:1qlpJh:_fMBXywewZHE4QbEAhRgCCWE1V4CCwCvipqzcUHBx4Y', '2023-10-12 11:36:25.957382'),
...
('lic4a9bmyknx283h4vqpwtb2t8ixqpwt', 'eyJ1c2VyaWQiOjJ9:1qlr8I:KSbam2hNXqd2dZYmLWkbpnPShTDVVE55UAMMIyAtETY', '2023-10-12 13:32:46.703347'),
...
--
-- Table structure for table `remote_user_cardiac_arrest_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_cardiac_arrest_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(300) NOT NULL,
  `Age_In_Days` varchar(300) NOT NULL,
  `Sex` varchar(300) NOT NULL,
  `ChestPainType` varchar(300) NOT NULL,
  `RestingBP` varchar(300) NOT NULL,
  `RestingECG` varchar(300) NOT NULL,
  `MaxHR` varchar(300) NOT NULL,
  `ExerciseAngina` varchar(300) NOT NULL,
  `Oldpeak` varchar(300) NOT NULL,
  `ST_Slope` varchar(300) NOT NULL,
  `slp` varchar(300) NOT NULL,
  `caa` varchar(300) NOT NULL,
  `thall` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=7 ;

--
-- Dumping data for table `remote_user_cardiac_arrest_prediction`
--

INSERT INTO `remote_user_cardiac_arrest_prediction` (`id`, `Fid`, `Age_In_Days`, `Sex`, `ChestPainType`, `RestingBP`, `RestingECG`, `MaxHR`, `ExerciseAngina`, `Oldpeak`, `ST_Slope`, `slp`, `caa`, `thall`, `Prediction`) VALUES
(1, '172.217.10.142-10.42.0.151-443-51582-6', '54', 'M', 'ATA', '110', 'Normal', '142', 'N', '0', 'Up', '2', '1', '3', 'No Cardiac Arrest Found'),
(2, '10.42.0.211-10.42.0.1-1420-53-17', '49', 'M', 'ASY', '140', 'Normal', '140', 'Y', '1', 'Flat', '1', '0', '2', 'Cardiac Arrest Found'),
(3, '172.217.10.227-10.42.0.151-443-34159-6', '42', 'F', 'NAP', '115', 'ST', '137', 'N', '0', 'Up', '2', '0', '2', 'No Cardiac Arrest Found'),
(4, '10.42.0.211-52.2.11.128-47676-443-6', '43', 'F', 'TA', '100', 'Normal', '142', 'N', '0', 'Up', '1', '0', '3', 'No Cardiac Arrest Found'),
(5, '203.205.158.54-10.42.0.151-80-58296-6', '44', 'M', 'ATA', '150', 'Normal', '150', 'Y', '3', 'Flat', '1', '0', '2', 'Cardiac Arrest Found'),
(6, '10.42.0.151-10.42.0.1-56397-53-17', '54', 'M', 'ASY', '140', 'Normal', '118', 'Y', '0', 'Flat', '1', '0', '1', 'Cardiac Arrest Found');
...
(1, 'Gopalan', 'Gopalan123@gmail.com', 'Gopalan', '9535866270', 'India', 'karnataka', 'Bangalore'),
...
(9, 'Artificial Neural Network (ANN)', '48.369565217391305'),
(10, 'SVM', '48.91304347826087'),
(11, 'Logistic Regression', '50.54347826086957'),
(12, 'Decision Tree Classifier', '49.45652173913043');
...
(18, 'No Cardiac Arrest Found', '50.0'),
(19, 'Cardiac Arrest Found', '50.0');
